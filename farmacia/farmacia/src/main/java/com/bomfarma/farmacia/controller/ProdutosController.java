package com.bomfarma.farmacia.controller;
...
import com.bomfarma.farmacia.repository.ProdutosRepository;
...
public class ProdutosController {
	...
	public ResponseEntity<List<Produtos>> getByName(@PathVariable String nome){
		return ResponseEntity.ok(repository.findAllbByNomeIgnoreCase(nome));
	}
